...
<section class="section-padding bg-light" id="contact" style="background: linear-gradient(rgba(var(--c-brand-rgb), 0.8), rgba(var(--c-brand-rgb), 0.8)),url(<?= baseUrl() ?>assets/img/counter.jpg) " >
        <div class="container">
            <div class="row">
